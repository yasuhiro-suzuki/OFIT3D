...
MODULE spline_mod
  ...
  INTEGER, PRIVATE, PARAMETER :: RP =  SELECTED_REAL_KIND(15)
  ...
  REAL(RP), PARAMETER :: c411 = -5.0_RP      / 2048.0_RP,   &
    &                    c412 =  9611.0_RP   / 737280.0_RP, &
    &                    c413 =  259.0_RP    / 23040.0_RP,  &
    &                    c414 = -6629.0_RP   / 46080.0_RP,  &
    &                    c415 = -7.0_RP      / 1152.0_RP,   &
    &                    c416 =  819.0_RP    / 1024.0_RP,   &
    &                    c417 =  1.0_RP      / 1440.0_RP,   &
    &                    c418 = -1067.0_RP   / 360.0_RP,    &
    &                    c41a =  3941.0_RP   / 576.0_RP,    &
    &                    c41c = -1603.0_RP   / 180.0_RP,    &
    &                    c41e =  901.0_RP    / 180.0_RP,    &
    &                    c421 =  49.0_RP     / 2048.0_RP,   &
    &                    c422 = -70733.0_RP  / 737280.0_RP, &
    &                    c423 = -499.0_RP    / 4608.0_RP,   &
    &                    c424 =  47363.0_RP  / 46080.0_RP,  &
    &                    c425 =  59.0_RP     / 1152.0_RP,   &
    &                    c426 = -86123.0_RP  / 15360.0_RP,  &
    &                    c427 = -1.0_RP      / 288.0_RP,    &
    &                    c431 = -245.0_RP    / 2048.0_RP,   &
    &                    c432 =  27759.0_RP  / 81920.0_RP,  &
    &                    c433 =  1299.0_RP   / 2560.0_RP,   &
    &                    c434 = -50563.0_RP  / 15360.0_RP,  &
    &                    c435 = -15.0_RP     / 128.0_RP,    &
    &                    c436 =  51725.0_RP  / 3072.0_RP,   &
    &                    c437 =  1.0_RP      / 160.0_RP,    &
    &                    c441 =  1225.0_RP   / 2048.0_RP,   &
    &                    c442 = -240077.0_RP / 147456.0_RP, &
    &                    c443 = -1891.0_RP   / 4608.0_RP,   &
    &                    c444 =  52931.0_RP  / 9216.0_RP,   &
    &                    c445 =  83.0_RP     / 1152.0_RP,   &
    &                    c446 = -86251.0_RP  / 3072.0_RP,   &
    &                    c447 = -1.0_RP      / 288.0_RP,    &
    &                    d413 =  c413 * 2.0_RP,                &
    &                    d423 =  c423 * 2.0_RP,                &
    &                    d433 =  c433 * 2.0_RP,                &
    &                    d443 =  c443 * 2.0_RP,                &
...
!Arguments
  ...
  SUBROUTINE spl1df (xd, & !(in) 
    ...
    IMPLICIT NONE
!Arguments
    REAL(RP), INTENT(IN)  :: xd
    REAL(RP), INTENT(OUT) :: w0(l1d)
!Local variables
...
!###########       case for m == 4       #############################
    ...
    x42m = (((-x400 * 7.0_RP + c426) * usx + c424) * usx + c422) * ux
    x42p =  ((c427  * usx    + c425) * usx + c423) * usx + c421

    x43m = (((x400 * 21.0_RP + c436) * usx + c434) * usx + c432) * ux
    x43p =  ((c437 * usx     + c435) * usx + c433) * usx + c431

    x44m = (((-x400 * 35.0_RP + c446) * usx + c444) * usx + c442) * ux
...
!############       case for m == 4       ###########################
    ...
    x42m  = (((-x400  * 7.0_RP  + c426) * usx + c424) * usx + c422) * ux
    x42p  =  ((c427   * usx     + c425) * usx + c423) * usx + c421
    dx42m =  ((-dx400 * 7.0_RP  + d426) * usx + d424) * usx + c422
    dx42p =  ((d427   * usx     + d425) * usx + d423) * ux

    x43m  = (((x400  * 21.0_RP + c436) * usx + c434) * usx + c432) * ux
    x43p  =  ((c437  * usx     + c435) * usx + c433) * usx + c431
    dx43m =  ((dx400 * 21.0_RP + d436) * usx + d434) * usx + c432
    dx43p =  ((d437  * usx     + d435) * usx + d433) * ux

    x44m  = (((-x400  * 35.0_RP + c446) * usx + c444) * usx + c442) * ux
    x44p  =  ((c447   * usx     + c445) * usx + c443) * usx + c441
    dx44m =  ((-dx400 * 35.0_RP + d446) * usx + d444) * usx + c442
...
!###########       case for m == 4       #############################
    ...
    x42m = (((-x400 * 7.0_RP + c426) * usx + c424) * usx + c422) * ux
    x42p =  ((c427  * usx    + c425) * usx + c423) * usx + c421
    y42m = (((-y400 * 7.0_RP + c426) * usy + c424) * usy + c422) * uy
    y42p =  ((c427  * usy    + c425) * usy + c423) * usy + c421

    x43m = (((x400 * 21.0_RP + c436) * usx + c434) * usx + c432) * ux
    x43p =  ((c437 * usx     + c435) * usx + c433) * usx + c431
    y43m = (((y400 * 21.0_RP + c436) * usy + c434) * usy + c432) * uy
    y43p =  ((c437 * usy     + c435) * usy + c433) * usy + c431

    x44m = (((-x400 * 35.0_RP + c446) * usx + c444) * usx + c442) * ux
    x44p =  ((c447  * usx     + c445) * usx + c443) * usx + c441
    y44m = (((-y400 * 35.0_RP + c446) * usy + c444) * usy + c442) * uy
...
!############       case for m == 4       ###########################
    ...
    y42p  =  ((c427   * usy    + c425) * usy + c423) * usy + c421
    dx42m =  ((-dx400 * 7.0_RP + d426) * usx + d424) * usx + c422
    dy42m =  ((-dy400 * 7.0_RP + d426) * usy + d424) * usy + c422
    dx42p =  ((d427   * usx    + d425) * usx + d423) * ux
    ...
    y43p  =  ((c437  * usy     + c435) * usy + c433) * usy + c431
    dx43m =  ((dx400 * 21.0_RP + d436) * usx + d434) * usx + c432
    dy43m =  ((dy400 * 21.0_RP + d436) * usy + d434) * usy + c432
    dx43p =  ((d437  * usx     + d435) * usx + d433) * ux
    ...
    y44p  =  ((c447   * usy     + c445) * usy + c443) * usy + c441
    dx44m =  ((-dx400 * 35.0_RP + d446) * usx + d444) * usx + c442
    dy44m =  ((-dy400 * 35.0_RP + d446) * usy + d444) * usy + c442
    dx44p =  ((d447   * usx     + d445) * usx + d443) * ux
  ...
  SUBROUTINE spl3df (xd, & !(in) 
    ...
    IMPLICIT NONE
!Arguments
    REAL(RP), INTENT(IN)  :: xd(3)
    REAL(RP), INTENT(OUT) :: w0(l3d)
!Local variables
    INTEGER, PARAMETER :: m2 = 8
    INTEGER :: l,  &
      &        mz, &
...
!###########       case for m == 4       #############################
    ...
    y42m = (((-y400 * 7.0_RP + c426) * usy + c424) * usy + c422) * uy
    y42p =  ((c427  * usy    + c425) * usy + c423) * usy + c421
    z42m = (((-z400 * 7.0_RP + c426) * usz + c424) * usz + c422) * uz
    ...
    y43m = (((y400 * 21.0_RP + c436) * usy + c434) * usy + c432) * uy
    y43p =  ((c437 * usy     + c435) * usy + c433) * usy + c431
    z43m = (((z400 * 21.0_RP + c436) * usz + c434) * usz + c432) * uz
    ...
    y44m = (((-y400 * 35.0_RP + c446) * usy + c444) * usy + c442) * uy
    y44p =  ((c447  * usy     + c445) * usy + c443) * usy + c441
    z44m = (((-z400 * 35.0_RP + c446) * usz + c444) * usz + c442) * uz
...
!############       case for m == 4       ###########################
    ...
    dx42m =  ((-dx400 * 7.0_RP + d426) * usx + d424) * usx + c422
    dy42m =  ((-dy400 * 7.0_RP + d426) * usy + d424) * usy + c422
    dz42m =  ((-dz400 * 7.0_RP + d426) * usz + d424) * usz + c422
    dx42p =  ((d427   * usx    + d425) * usx + d423) * ux
    dy42p =  ((d427   * usy    + d425) * usy + d423) * uy
    ...
    dx43m =  ((dx400 * 21.0_RP + d436) * usx + d434) * usx + c432
    dy43m =  ((dy400 * 21.0_RP + d436) * usy + d434) * usy + c432
    dz43m =  ((dz400 * 21.0_RP + d436) * usz + d434) * usz + c432
    dx43p =  ((d437  * usx     + d435) * usx + d433) * ux
    dy43p =  ((d437  * usy     + d435) * usy + d433) * uy
    ...
    dx44m =  ((-dx400 * 35.0_RP + d446) * usx + d444) * usx + c442
    dy44m =  ((-dy400 * 35.0_RP + d446) * usy + d444) * usy + c442
    dz44m =  ((-dz400 * 35.0_RP + d446) * usz + d444) * usz + c442
    dx44p =  ((d447   * usx     + d445) * usx + d443) * ux
    dy44p =  ((d447   * usy     + d445) * usy + d443) * uy
